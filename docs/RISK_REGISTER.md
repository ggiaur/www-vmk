...
| R-03 | A 2026-08-03-i WCAG 2.2 AA auditban **15/16 oldal elbukott**, döntően `color-contrast` hibák miatt (pl. fehér szöveg `#00909B` háttéren = 3.84:1 a szükséges 4.5:1 helyett; `#e4b02c` arany szöveg fehér háttéren = 1.99:1) | Magas | Korábban biztos; jelenleg mitigált | `npx playwright test tests/e2e/accessibility.spec.ts`, újramérve 2026-09-05; `docs/evidence/VMK-WCAG-HARDENING-B1/REPORT.md` | **Mitigálva.** A kötelező teszt 15/15 publikus útvonala 0 axe-hibával fut; a további 8 statikus útvonal kiterjesztett auditja 2 hibáról 0-ra javult. A pontos `#00909B` és `#e4b02c` megmaradt dekoratív, illetve sötét szöveggel párosított helyeken; a szöveget hordozó teal felületek elkülönített AA-tokeneket használnak. A bizonyíték és a megmaradt, összeegyeztethetetlen esetek vizsgálata a hivatkozott riportban található. |
