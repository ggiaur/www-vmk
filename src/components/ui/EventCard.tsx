...
export const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    <div className="bg-white rounded border border-slate-200 p-5 flex gap-4">
      {/* Date badge */}
      <div className="shrink-0 w-16 h-20 rounded bg-[#2563eb] text-white flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <h3 className="font-bold text-slate-900 text-base leading-snug line-clamp-2 hover:text-[#2563eb] transition-colors mb-2">
        ...
        <div className="mt-auto flex items-center justify-between pt-2 border-t border-slate-100 text-xs font-semibold">
          <Link href={`/esemenyek/${slug}`} className="text-[#2563eb] hover:underline flex items-center gap-1">
            <span>Részletek</span>
          ...
          {registrationUrl && (
            <a
              ...
              className="bg-[#7c3aed] hover:bg-[#b04b26] text-white px-2.5 py-1 rounded text-[11px] transition-colors"
            >
              Regisztráció
            </a>
          )}
