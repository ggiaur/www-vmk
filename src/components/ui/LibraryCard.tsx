...
export const LibraryCard: React.FC<LibraryCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm card-hover-effect flex flex-col justify-between">
      <div>
        <span className="text-xs px-2.5 py-1 rounded font-medium bg-amber-50 text-[#8C1D11] border border-amber-200/60 inline-block mb-3">
      ...
      <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-[#8C1D11]">
