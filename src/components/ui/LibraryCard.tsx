...
export const LibraryCard: React.FC<LibraryCardProps> = ({
  ...
  return (
    <div className="bg-white rounded border border-slate-200 p-5 flex flex-col justify-between">
      <div>
        <span className="text-xs px-2.5 py-1 rounded font-medium bg-amber-50 text-[#2563eb] border border-amber-200/60 inline-block mb-3">
          {typeLabels[type] || 'Tagkönyvtár'}
        </span>

        <h3 className="font-bold text-slate-900 text-lg mb-3 hover:text-[#2563eb] transition-colors">
