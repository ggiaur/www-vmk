...
export const LibraryCard: React.FC<LibraryCardProps> = ({
  ...
  return (
    <div className="bg-white rounded border border-slate-200 p-5 flex flex-col justify-between">
      <div>
        <span className="text-xs px-2.5 py-1 rounded font-medium bg-amber-50 text-[#f59e0b] border border-amber-200/60 inline-block mb-3">
          {typeLabels[type] || 'Tagkönyvtár'}
        </span>

        <h3 className="font-bold text-slate-900 text-lg mb-3 hover:text-[#f59e0b] transition-colors">
        ...
        <div className="space-y-2 text-xs text-slate-600 mb-4">
          ...
          {email && (
            <div className="flex items-center gap-2">
              <Mail className="w-4 h-4 text-[#818cf8] shrink-0" />
      ...
      <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-[#f59e0b]">
