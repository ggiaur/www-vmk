  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-6 space-y-8">
      ...
      <div className="space-y-4">
        <Link
          href="/esemenyek"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#8C1D11] hover:underline"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-amber-50/80 p-5 rounded-xl border border-amber-200 text-sm">
        <div className="flex items-center gap-3">
          <Calendar className="w-5 h-5 text-[#8C1D11] shrink-0" />
          <div>
        ...
        <div className="flex items-center gap-3">
          <Users className="w-5 h-5 text-[#8C1D11] shrink-0" />
          <div>
