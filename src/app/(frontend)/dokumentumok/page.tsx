    ...
    <PageWithSidebar>
      <div>
        ...
        <table className="w-full border-collapse text-[14px]" style={{ fontFamily: 'Roboto, sans-serif' }}>
          <thead>
            <tr>
              <th className="text-left py-[8px] px-[15px] border border-[#ddd] bg-[#f59e0b] text-white font-bold">
                Dokumentum neve
              </th>
              <th className="text-left py-[8px] px-[15px] border border-[#ddd] bg-[#f59e0b] text-white font-bold w-[120px]">
                Kategória
              </th>
              <th className="text-center py-[8px] px-[15px] border border-[#ddd] bg-[#f59e0b] text-white font-bold w-[60px]">
                Év
              </th>
              <th className="text-center py-[8px] px-[15px] border border-[#ddd] bg-[#f59e0b] text-white font-bold w-[100px]">
                Letöltés
              </th>
            </tr>
          </thead>
