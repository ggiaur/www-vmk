  ...
  return (
    <PageWithSidebar>
      ...
      <div className="space-y-4">
        <Link
          href="/hirek"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#f59e0b] hover:underline"
        >
      ...
      <div className="bg-amber-50/60 border-l-4 border-[#f59e0b] p-4 rounded-r-lg text-slate-800 text-base leading-relaxed font-medium">
        {summary}
      </div>
