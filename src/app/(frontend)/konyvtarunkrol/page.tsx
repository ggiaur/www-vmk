      ...
      <div>
        ...
        <div className="text-[14px] leading-[22px] text-[#333] space-y-4" style={{ fontFamily: 'Roboto, sans-serif' }}>
          ...
          <ul className="list-none space-y-2 pl-0">
            <li>
              <Link href="/munkatarsak" className="text-[#f59e0b] hover:underline">Munkatársaink</Link>
            </li>
            <li>
              <Link href="/dokumentumok" className="text-[#f59e0b] hover:underline">Alapdokumentumok</Link>
            </li>
            <li>
              <Link href="/kapcsolat" className="text-[#f59e0b] hover:underline">Elérhetőségeink</Link>
            </li>
            <li>
              <Link href="/nyitvatartas" className="text-[#f59e0b] hover:underline">Nyitvatartás</Link>
            </li>
          </ul>
        </div>
      </div>
