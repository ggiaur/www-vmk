      ...
      <div>
        ...
        <div className="text-[14px] leading-[22px] text-[#333] space-y-4" style={{ fontFamily: 'Roboto, sans-serif' }}>
          ...
          <ul className="list-none space-y-2 pl-0">
            <li>
              <Link href="/munkatarsak" className="text-[#137F85] hover:underline">Munkatársaink</Link>
            </li>
            <li>
              <Link href="/dokumentumok" className="text-[#137F85] hover:underline">Alapdokumentumok</Link>
            </li>
            <li>
              <Link href="/kapcsolat" className="text-[#137F85] hover:underline">Elérhetőségeink</Link>
            </li>
            <li>
              <Link href="/nyitvatartas" className="text-[#137F85] hover:underline">Nyitvatartás</Link>
            </li>
          </ul>
        </div>
      </div>
