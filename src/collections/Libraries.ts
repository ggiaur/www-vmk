...
export const Libraries: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        description:
          'A munkatársak oldalon ez a szín jelenik meg a részleg/tagkönyvtár fejlécén, pl. #f59e0b.',
        position: 'sidebar',
      },
      validate: (value: unknown) => {
        if (!value) return true
        return /^#[0-9a-fA-F]{6}$/.test(String(value)) || 'Érvénytelen hex szín (pl. #f59e0b).'
      },
    },
    {
      name: 'address',
