...
* **WCAG 2.2 AA audit ténylegesen lefutott (2026-08-03)** — a korábbi állítás, miszerint a Chromium nem indítható ebben a sandbox-környezetben, **elavultnak/tévesnek bizonyult**: a Playwright Chromiumja ma többször is sikeresen elindult (pixel-diff mérésekhez és ehhez az audithoz is). A valós eredmény: **15/16 oldal elbukik**, döntően `color-contrast` hibák miatt (részletek: `docs/RISK_REGISTER.md` R-03, R-04). Ez egy nyitott, valós hiba, nem egy le nem futtatott teszt.
